<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Browniedb.aspx.cs" Inherits="GirlsGK.Browniedb" %>
...
<body class="center">
    ...
    <form runat="server">
        <div class="container">  
            <h1 style="color:darkgoldenrod">Brownies</h1>
...
&nbsp;<asp:Label ID="Label8" runat="server"></asp:Label>
            ...
            <div class="container">
            <a href="BrownieDynamic.aspx">Back To Admin Page</a>
        </div>
        <br />
        <br />
        <br />
