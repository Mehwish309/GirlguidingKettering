<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuidesDynamic.aspx.cs" Inherits="GirlsGK.GuidesDynamic" %>
<!doctype html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
   ...
   <form id="simpleForm" class="bg-white" runat="server">
        ...
        <div class="container shadow-lg p-5 mb-auto bg-white rounded bg-light" data-spy="scroll" data-offset="0">
            <div class="row margin">
                <div class="col-md-12">
                    <center>
                        <h1><img src="img/Guidesdynamic.png" alt="Alternate Text" /></h1>
                     </center>
                    <hr class="line" />
                </div>
            </div>
            ...
            <div class="col-md-5">
                <asp:FileUpload ID="Fileimgsave" runat="server" Height="20px" Width="300px" />
            </div>
            <br />
            <!----Calender start--->
            <div class="col-1">
