<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rangers.aspx.cs" Inherits="GirlsGK.Rangers" %>
<!doctype html>
<html lang="en">
<head>
    <!-- Required meta tags -->
...
<body class="bg-dark">
    <form id="form1" runat="server">
        ...
        <div class="container bg-dark">
            ...
            <br />
            <br />
            <h1 style="color: aqua">Welcome To Rangers & YoungLeader Kettering</h1>
        ...
        <div>
            <div class="container shadow-lg p-5 mb-auto rounded bg-light" data-spy="scroll" data-offset="0" style="text-align: center">
                <asp:ListView ID="LVRanger" runat="server">
                    <ItemTemplate>
                ...
                <a href="DashboardYoungLeader.aspx" style="color: aqua">Back To Dashboard</a>
            </div>
        </div>
