<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RangersDynamic.aspx.cs" Inherits="GirlsGK.RangersDynamic" %>
    ...
    <form id="simpleForm" class="bg-white" runat="server">
        ...
        <div class="container shadow-lg p-5 mb-auto bg-white rounded bg-light" data-spy="scroll" data-offset="0">
            <div class="row margin">
                <div class="col-md-12">
                    <center>
                        <h1><img src="img/Rangersdyn.png" alt="Alternate Text" /></h1>
                     </center>
                    <hr class="line" />
                </div>
            </div>
            ...
            <!--Images--->
            <div class="col-md-5">
                <asp:FileUpload ID="Fileimgsave" runat="server" Height="20" Width="10" />
            </div>
            <br />
            ...
            <div class="col-sm-5">
                <asp:TextBox type="date" ID="txtDate" runat="server" BackColor="#99CCFF"
                    BorderColor="Blue" BorderStyle="Solid"></asp:TextBox>
                <asp:RequiredFieldValidator ErrorMessage="Please Select the date" CssClass="text-danger"
            ...
            <div class="col-md-5">
                <asp:Button Text="Add" type="Button" CssClass="btn btn-primary" runat="server" Width="170px" OnClick="Add_Click" />
                &nbsp;&nbsp;
              <asp:Button CssClass="btn btn-primary" Text="Logout" runat="server" CausesValidation="false" OnClick="logoutsession_Click" />
                &nbsp;&nbsp;
              <asp:Button CssClass="btn btn-primary" Text="Update" runat="server" CausesValidation="false" OnClick="Update_Click" />
            </div>
            <div class="col-md-5">
