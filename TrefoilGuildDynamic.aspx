<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrefoilGuildDynamic.aspx.cs" Inherits="GirlsGK.TrefoilGuildDynamic" %>
...
<head>
    ...
    <title>Trefoil Guild | Girlguiding</title>
    <!----Bootstrap--->
</head>
<body>
    <form id="simpleForm" class="bg-white" runat="server">
        ...
        <div class="container shadow-lg p-5 mb-auto bg-white rounded bg-light" data-spy="scroll" data-offset="0">
            <div class="row margin">
                <div class="col-md-12">
                    <center>
                        <h1><img src="img/TrefoilguildActivity.png" alt="Alternate Text" /></h1>
                     </center>
                    <hr class="line" />
                </div>
            </div>
            ...
            <!--Images--->
            <div class="col-md-5">
                <asp:FileUpload ID="Fileimgsave" runat="server" Height="37px" Width="555px" />
            </div>
            <!----Calender start--->
            <div class="col-md-5">
