...
namespace GirlsGK
{
    public partial class RangersDynamic : System.Web.UI.Page
    {
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            {
                imageName = "Imagenotfoundrangers.png";
            }
            ...
            if (title != "" && date != null && description != "")
            {
                if (".jpg" == Path.GetExtension(imageName) || ".png" == Path.GetExtension(imageName))
                {
                    ...
                    using (SqlConnection con = new SqlConnection(CS))
                    {
                        ...
                        string query = "INSERT INTO RangersActivity(Title, Image, Date, Description) VALUES(@title, @Image, @Date, @description)";
        ...
        {
            Response.Redirect("Rangersdb.aspx");
        }
    }
}