<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrownieDynamic.aspx.cs" Inherits="GirlsGK.BrownieDynamic" %>
        ...
        <br />
         <div class="container shadow-lg p-5 mb-auto bg-white rounded bg-light" data-spy="scroll" data-offset="0">
            <div class="row margin">
                <div class="col-md-12">
                    <center>
                        <h1><img src="img\Browniedynamic.png" alt="Alternate Text" /></h1>
                    </center>
                    <hr class="line" />
                </div>
            </div>
            ...
            <div class="col-md-5">
                ...
                <asp:RequiredFieldValidator ErrorMessage="Enter your Title" CssClass="text-danger"
