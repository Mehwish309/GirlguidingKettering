...
namespace GirlsGK
{
    public partial class BrownieDynamic : System.Web.UI.Page
    {
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            {
                imageName = "Imagenotfoundbrownies.png";                
            }
            ...
            if (title != "" && date != null && description != "")
            {
                if (".jpg" == Path.GetExtension(imageName) || ".png" == Path.GetExtension(imageName))
                {
                    ...
                    using (SqlConnection con = new SqlConnection(CS))
                    {
                        ...
                        string query = "INSERT INTO BrownieActivity(Title, Image, Date, Description) VALUES(@title, @Image, @Date, @description)";
        ...
        {
            Response.Redirect("Browniedb.aspx");
        }
    }
}