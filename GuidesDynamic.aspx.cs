...
namespace GirlsGK
{
    public partial class GuidesDynamic : System.Web.UI.Page
    {
        ...
        protected void Unnamed1_Click(object sender, EventArgs e)
        {
            ...
            {
                imageName = "Imagenotfoundguides.png";
            }
            ...
            if (title != "" && date != null && description != "")
            {
                if (".jpg" == Path.GetExtension(imageName) || ".png" == Path.GetExtension(imageName))
                {
                    ...
                    using (SqlConnection con = new SqlConnection(CS))
                    {
                        ...
                        string query = "INSERT INTO GuideActivity(Title, Image, Date, Description) VALUES(@title, @Image, @Date, @description)";
        ...
        {
            Response.Redirect("Guidesdb.aspx");
        }
    }
}